...
instructBtn.addEventListener("click", (e) => {
    alert("Welcome to Rock-Paper-Scissors! This game is a best of 5 and ties do not count torward anyone's score.ENJOY !");
    alert("Press your desired option to begin.");
});
...
function gameRock() {
    ...
    if (numberOfRounds < 4) {
        ...
        alert("You have completed 1 round of 5 games. Please reset if you wish to play again.");
    }
}
...
function gameScissors() {
    ...
    if (numberOfRounds < 4) {
        ...
        alert("You have completed 1 round of 5 games. Please reset if you wish to play play again.");
    }
}
